...
Please provide your analysis in the following JSON format:
{
  ...
  "posterPrompt": "Detailed prompt for 1080x1350 magazine-quality editorial poster. STYLE CONSISTENCY IS THE HIGHEST PRIORITY - You MUST strictly follow the established visual style from brandStrategy, do NOT reinvent or mix styles. The poster is an EXTENSION of the brand assets, not a new creation. On top of the locked style, elevate to editorial quality: 1) Editorial, not promotional - treat the project mascot/character as the subject of an editorial portrait or fashion shoot, not as a cartoon illustration 2) Typography-driven composition with ticker ${input.ticker} as a stylized design element 3) Print-first, CMYK-aware color sensibility using the brand color palette 4) Strong use of negative space or controlled density 5) The result should feel like a magazine spread, exhibition poster, or cultural artifact 6) Maintain high cultural taste and visual restraint - no hype, no call-to-action, no marketing layout. The poster MUST feel like it belongs to the EXACT same visual universe as the hero background and community scene.",
  "posterSectionContent": {
