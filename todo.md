...
- [ ] 修改 HTML 生成提示词，Footer 不再包含 Logo
- [ ] 修改 CSS 生成提示词，移除 footer-logo 相关样式说明
...
## Bug修复 - Slug迁移透明背景丢失（重新修复）
- [x] 修复 slug 迁移时 Feature Icon 透明背景丢失的问题


## 功能修复 - 免费期间开关控制全网免费生成
- [x] 修改服务端 launch.trigger 添加免费期间检查
- [x] 修改前端 LaunchV2 在免费期间跳过钱包检查
...
## 钱包签名文案优化
- [x] 更新 WalletConnectButton 组件的签名提示为中英双语
- [x] 更新 SIWE 签名消息内容，添加中文说明
- [x] 更新连接钱包下拉菜单的提示文案
