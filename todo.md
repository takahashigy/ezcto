...
## 多模板选择功能
- [x] 分析现有网页生成 Prompt 和模块结构
- [x] 设计多模板风格配置（活泽Meme风、专业DeFi风、艺术NFT风等）
- [x] 更新网页生成 Prompt 加入风格选择逻辑
- [x] 测试不同风格的网页生成效果（单元测试通过）
- [x] 保存 checkpoint

## 新增特色风格模板
- [x] 设计“暗黑赛博朋克”模板（dark-cyberpunk）
- [x] 设计“复古像素风”模板（retro-pixel）
- [x] 更新模板选择逻辑以支持新模板
