  ...
  en: {
    ...
    modules: {
      ...
      sdn: {
        ...
        tag: 'COMING SOON',
        description: 'Build a web2 "nuclear arsenal". AI video matrix automatically generates dynamic content for projects, distributes to TikTok/Web2 platforms, attracts hundreds of millions of traffic growth.',
        features: {
          ai: 'AI video matrix automatic generation',
          tiktok: 'One-click smart distribution',
      ...
      alchemy: {
        title: 'Alchemy Plan',
        tag: 'COMING SOON',
        description: 'Based on Stable Diffusion training exclusive Meme image generation model. Deeply understand Meme aesthetics, generate higher quality startup assets, reduce user threshold.',
        features: {
          sd: 'Based on Stable Diffusion training',
          meme: 'Exclusive Meme aesthetic model',
          quality: 'Significantly improve generation quality',
        },
      ...
      lora: {
        title: 'Lora Workshop',
        tag: 'COMING SOON',
        description: 'Provide exclusive Lora model training service for excellent Meme characters. Ensure long-term visual asset style consistency, extend IP lifecycle.',
        features: {
          exclusive: 'Exclusive Lora model training',
          consistency: 'Ensure visual style consistency',
          lifecycle: 'Extend IP lifecycle',
        },
    ...
    flywheel: {
      ...
      step1: 'Automated engine attracts massive project parties',
      step2: 'Alchemy Plan improves startup asset quality',
      step3: 'Social distribution network screens high-potential projects',
      step4: 'IP merchandise supply chain helps commercialization',
      step5: 'Lora Workshop extends IP lifecycle',
      step6: 'Official store hot sales list becomes value discovery standard',
      step7: 'Attracts top star traffic, achieves ultimate breakthrough',
    },
    templates: {
  ...
  zh: {
    ...
    modules: {
      ...
      sdn: {
        title: '社交分发网络（SDN）',
        tag: 'COMING SOON',
        description: '打破web2上的"核武库"。AI视频矩阵自动为项目生成动态内容对材料，系统化分发至TikTok等Web2平台，实现跨语言无缝覆盖，吸引数据级流量增长。',
        features: {
          ai: 'AI视频矩阵自动生成',
          tiktok: '一键智能分发',
          data: '数据驱动优化',
      ...
      alchemy: {
        title: '炼丹计划',
        tag: 'COMING SOON',
        description: '基于Stable Diffusion训练专属Meme图片生成大模型。深度理解Meme美学，生成更高质量的启动资产，降低用户门槛。',
        features: {
          sd: '基于Stable Diffusion训练',
          meme: '专属Meme美学模型',
          quality: '显著提升生成质量',
        },
        comingSoon: 'Coming Q4 2026',
      ...
      lora: {
        title: 'Lora炼制工坊',
        tag: 'COMING SOON',
        description: '为优秀的Meme角色提供专属Lora模型训练服务。确保长期视觉资产风格一致性，延长IP生命周期。',
        features: {
          exclusive: '专属Lora模型训练',
          consistency: '确保视觉风格一致',
          lifecycle: '延长IP生命周期',
        },
        comingSoon: 'Coming Soon',
      },
    ...
    flywheel: {
      ...
      step2: '炼丹计划提升启动资产质量',
      step3: '社交分发网络筛选高潜力项目',
      step4: 'IP实体化供应链帮助商业变现',
      step5: 'Lora炼制工坊延长IP生命周期',
      step6: '官方商城的热销榜成为价值发现标准',
