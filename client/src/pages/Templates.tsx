...
const templates = [
  ...
  },
  {
    ...
    description: "超大字体，强烈对比，粗野主义极简设计",
    适用场景: "艺术项目/高端品牌/实验性项目",
    colors: ["#000000", "#FFFFFF", "#FF0000", "#0000FF"],
    fonts: "Arial Black, Helvetica",
  ...
  },
  {
    id: "internet-meme",
    name: "Wojak Style",
    description: "完整复刻Wojak网站，漫画风格，黑色描边",
    适用场景: "表情包/情绪meme/社区文化项目",
    colors: ["#00BFFF", "#FFD700", "#000000", "#FFFFFF"],
    fonts: "Bangers, Luckiest Guy",
