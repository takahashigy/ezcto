...
const translations = {
  en: {
    ...
    launch: {
      ...
      v2: {
        ...
        form: {
          ...
          tokenomics: 'Tokenomics (Optional)',
          tokenomicsPlaceholder: 'e.g., Total supply 1B, 50% LP, 30% community...',
          contractAddress: 'Contract Address (Optional)',
          contractAddressPlaceholder: '0x...',
          characterImage: 'Character Image',
          uploadPrompt: 'Click to upload or drag and drop',
          uploadFormat: 'PNG, JPG, WEBP (Max 16MB)',
        ...
        whatYouGet: {
          ...
          logo: 'Logo (512x512)',
          heroBackground: 'Hero Background (1920x1080)',
          communityScene: 'Community Scene (800x600)',
          featureIcons: '3x Feature Icons (256x256)',
          website: 'Complete Website',
          websiteDesc: 'Deployed to *.ezcto.fun subdomain',
        },
        buttons: {
          submit: 'Generate Now',
      ...
      preview: {
        ...
        redirecting: 'Your project is ready! Redirecting to project details...',
        ...
        analysis: 'Analysis',
        analysisDesc: 'AI analyzing your project and determining design style',
        images: 'Images',
        imagesDesc: 'Generating 8 unique images (logo, banners, backgrounds, icons)',
        website: 'Website',
        websiteDesc: 'Creating complete website with your branding',
        deployment: 'Deployment',
        deploymentDesc: 'Deploying to public URL',
    ...
    cryptoPayment: {
      ...
      bestRate: 'Best Rate',
      payWithEzcto: 'Pay with EZCTO Token',
      saveAmount: 'Save',
      whenPayWithEzcto: 'when you pay with EZCTO!',
      buyEzctoOnPancake: 'Buy EZCTO on PancakeSwap',
      selectNetwork: 'Select Network',
      selectToken: 'Select Token',
      yourEzctoBalance: 'Your EZCTO Balance',
      required: 'Required',
      yourBalance: 'Your Balance',
      sufficientBalance: 'Sufficient balance for payment',
      needMore: 'Need',
      moreEzcto: 'more EZCTO',
      youSave: 'You Save',
      payWithEzctoEnjoy: 'Pay with EZCTO token and enjoy the best rate!',
      amount: 'Amount',
      loading: 'Loading...',
      usdValue: 'USD Value',
      ezctoPrice: 'EZCTO Price',
      switchToEzcto: 'Switch to EZCTO and save',
      useEzcto: 'Use EZCTO',
      switchToNetwork: 'Please switch to',
      ...
      insufficientBalance: 'Insufficient EZCTO Balance',
      pay: 'Pay',
      save: 'Save',
      bestDeal: 'Best deal! Pay with EZCTO token on BSC',
      otherAccepted: 'ETH, USDT, and USDC are also accepted at',
      needEzcto: 'Need EZCTO? Buy on PancakeSwap',
      transactionSent: 'Transaction Sent',
      waitingConfirmation: 'Waiting for confirmation...',
      paymentConfirmed: 'Payment Confirmed!',
      deploymentUnlocked: 'Your website deployment is now unlocked.',
      paymentFailed: 'Payment Failed',
      networkSwitchFailed: 'Network Switch Failed',
      switchManually: 'Please switch network manually in your wallet',
    },
    pricing: {
      title: 'Simple Pricing',
      subtitle: 'Pay with EZCTO token and save 50%',
      standard: 'Standard',
      standardDesc: 'Pay with any crypto',
      ezctoToken: 'EZCTO Token',
      ezctoDesc: 'Pay with EZCTO on BSC',
      feature1: 'Full website generation',
      feature2: 'All banner images',
      feature3: 'Custom domain support',
      saveExtra: 'Save $100!',
      bestValue: 'BEST VALUE',
      getStarted: 'Get Started',
      launchWithEzcto: 'Launch with EZCTO',
      buyEzcto: 'Buy EZCTO on PancakeSwap',
    },
    customOrder: {
      page: {
  ...
  zh: {
    ...
    launch: {
      ...
      v2: {
        ...
        form: {
          ...
          tokenomics: '代币经济学（可选）',
          tokenomicsPlaceholder: '例如：总供应量10亿，50% LP，30%社区...',
          contractAddress: '合约地址（可选）',
          contractAddressPlaceholder: '0x...',
          characterImage: '角色图片',
          uploadPrompt: '点击上传或拖拽文件',
          uploadFormat: 'PNG, JPG, WEBP（最多16MB）',
          socialLinks: '社交链接（可选）',
          twitter: 'Twitter/X',
          twitterPlaceholder: 'https://x.com/...',
          telegram: 'Telegram',
        ...
        whatYouGet: {
          ...
          xBanner: 'X/Twitter Banner (1200x480)',
          logo: 'Logo (512x512)',
          heroBackground: 'Hero背景 (1920x1080)',
          communityScene: '社区场景 (800x600)',
          featureIcons: '3个功能图标 (256x256)',
          website: '完整网站',
          websiteDesc: '部署到 *.ezcto.fun 子域名',
        },
        buttons: {
          submit: '立即生成',
          submitting: '生成中...',
    ...
    cryptoPayment: {
      ...
      recommended: '推荐',
      bestRate: '最优价格',
      payWithEzcto: '使用 EZCTO 代币支付',
      saveAmount: '立省',
      whenPayWithEzcto: '使用 EZCTO 支付即可享受折扣！',
      buyEzctoOnPancake: '在 PancakeSwap 购买 EZCTO',
      selectNetwork: '选择网络',
      selectToken: '选择代币',
      yourEzctoBalance: '你的 EZCTO 余额',
      required: '所需',
      yourBalance: '你的余额',
      sufficientBalance: '余额充足，可以支付',
      needMore: '还需要',
      moreEzcto: 'EZCTO',
      youSave: '你省了',
      payWithEzctoEnjoy: '使用 EZCTO 代币支付，享受最优价格！',
      amount: '数量',
      loading: '加载中...',
      usdValue: '美元价值',
      ezctoPrice: 'EZCTO 价格',
      switchToEzcto: '切换到 EZCTO 立省',
      useEzcto: '使用 EZCTO',
      switchToNetwork: '请切换到',
      toContinue: '以继续',
      switchTo: '切换到',
      connected: '已连接',
      nativeBalance: '原生代币余额',
      transactionSubmitted: '交易已提交',
      viewOnExplorer: '在区块浏览器查看',
      processing: '处理中...',
      insufficientBalance: 'EZCTO 余额不足',
      pay: '支付',
      save: '省',
      bestDeal: '最优价格！使用 EZCTO 代币在 BSC 链支付',
      otherAccepted: 'ETH、USDT 和 USDC 也可以支付，价格为',
      needEzcto: '需要 EZCTO？在 PancakeSwap 购买',
      transactionSent: '交易已发送',
      waitingConfirmation: '等待确认中...',
      paymentConfirmed: '支付成功！',
      deploymentUnlocked: '你的网站部署已解锁。',
      paymentFailed: '支付失败',
      networkSwitchFailed: '网络切换失败',
      switchManually: '请在钱包中手动切换网络',
    },
    pricing: {
      title: '简单定价',
      subtitle: '使用 EZCTO 代币支付立省 50%',
      standard: '标准版',
      standardDesc: '支持任意加密货币支付',
      ezctoToken: 'EZCTO 代币',
      ezctoDesc: '使用 EZCTO 在 BSC 链支付',
      feature1: '完整网站生成',
      feature2: '全部 Banner 图片',
      feature3: '自定义域名支持',
      saveExtra: '立省 $100！',
      bestValue: '最优价格',
      getStarted: '立即开始',
      launchWithEzcto: '使用 EZCTO 启动',
      buyEzcto: '在 PancakeSwap 购买 EZCTO',
    },
    customOrder: {
      page: {
        tag: '供应链定制',
